...
module OpenApiSDK
  module Operations
    class SearchPeopleApplicationJSON < OpenApiSDK::Utils::FieldAugmented
      extend T::Sig

            # Filter for searching
      field :filter, T.nilable(String), { 'format_json': { 'letter_case': OpenApiSDK::Utils.field_name('filter') } }      # Number of results per page (0-100)
    ...
    class SearchPeopleResponse < OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
