...
module OpenApiSDK
  class TestParameter < Minitest::Test
    ...
    def test_simple_path_parameter_primitives
      ...
      res = @sdk.parameters.simple_path_parameter_primitives(request=Operations::SimplePathParameterPrimitivesRequest.new(
          str_param:  "test",
          bool_param: true,
          int_param:  1,
          num_param:  1.1,
    ...
    def test_simple_path_parameter_objects
      ...
      res = @sdk.parameters.simple_path_parameter_objects(Operations::SimplePathParameterObjectsRequest.new(
      ...
      assert_equal(Rack::Utils.status_code(:ok), res.status_code)
      refute_nil(res.res)
      assert_equal("http://localhost:35123/anything/pathParams/obj/any,any,bool,true,date,2020-01-01,dateTime,2020-01-01T00:00:00.000000001Z,enum,one,float32,1.1,int,1,int32,1,num,1.1,str,test,boolOpt,true,strOpt,testOptional/objExploded/any=any,bool=true,date=2020-01-01,dateTime=2020-01-01T00:00:00.000000001Z,enum=one,float32=1.1,int=1,int32=1,num=1.1,str=test,boolOpt=true,strOpt=testOptional", res.res.url)
    end

    def test_simple_path_parameter_arrays
      record_test('parameters-simple-path-parameter-arrays')

      res = @sdk.parameters.simple_path_parameter_arrays(Operations::SimplePathParameterArraysRequest.new(
    ...
    def test_simple_path_parameter_maps
      ...
      res = @sdk.parameters.simple_path_parameter_maps(Operations::SimplePathParameterMapsRequest.new(
        map_param: {
          :test =>  "value",
          :test2 => "value2",
        },
    ...
    #   res = @sdk.parameters.path_parameter_json(request=Operations::PathParameterJsonRequest.new(
    #       json_obj: create_simple_object,
    #     )
    #   )
    #   refute_nil(res)
    #   assert_equal(Rack::Utils.status_code(:ok), res.status_code)
    ...
    def test_form_query_params_primitive
      ...
      res = @sdk.parameters.form_query_params_primitive(Operations::FormQueryParamsPrimitiveRequest.new(
        bool_param: true,
        int_param:  1,
        num_param:  1.1,
        str_param:  "test",
    ...
    def test_form_query_params_object
      ...
      res = @sdk.parameters.form_query_params_object(Operations::FormQueryParamsObjectRequest.new(
          obj_param:         obj,
      ...
      assert_equal(Rack::Utils.status_code(:ok), res.status_code)
      refute_nil(res.res)
      assert_equal("http://localhost:35123/anything/queryParams/form/obj?any=any&bool=true&boolOpt=true&date=2020-01-01&dateTime=2020-01-01T00%3A00%3A00.000000001Z&enum=one&float32=1.1&int=1&int32=1&num=1.1&objParam=any%2Cany%2Cbool%2Ctrue%2Cdate%2C2020-01-01%2CdateTime%2C2020-01-01T00%3A00%3A00.000000001Z%2Cenum%2Cone%2Cfloat32%2C1.1%2Cint%2C1%2Cint32%2C1%2Cnum%2C1.1%2Cstr%2Ctest%2CboolOpt%2Ctrue%2CstrOpt%2CtestOptional&str=test&strOpt=testOptional", res.res.url)
      assert_equal("test", res.res.args.str)
      ...
      assert_equal("any,any,bool,true,date,2020-01-01,dateTime,2020-01-01T00:00:00.000000001Z,enum,one,float32,1.1,int,1,int32,1,num,1.1,str,test,boolOpt,true,strOpt,testOptional", res.res.args.obj_param)
    end
    ...
    def test_form_query_params_ref_param_object
      ...
      res = @sdk.parameters.form_query_params_ref_param_object(Operations::FormQueryParamsRefParamObjectRequest.new(
    ...
    def test_form_query_params_array
      ...
      res = @sdk.parameters.form_query_params_array(Operations::FormQueryParamsArrayRequest.new(
        arr_param: ["test", "test2"],
    ...
    def test_form_query_params_map
      ...
      res = @sdk.parameters.form_query_params_map(Operations::FormQueryParamsMapRequest.new(
          map_param: {
            "test":  "value",
            "test2": "value2",
          },
    ...
    def test_deep_object_query_params_object
      ...
      res = @sdk.parameters.deep_object_query_params_object(Operations::DeepObjectQueryParamsObjectRequest.new(
          obj_param: obj,
      ...
      assert_equal(Rack::Utils.status_code(:ok), res.status_code)
      refute_nil(res.res)
      assert_equal("http://localhost:35123/anything/queryParams/deepObject/obj?objArrParam[arr]=test&objArrParam[arr]=test2&objParam[any]=any&objParam[boolOpt]=true&objParam[bool]=true&objParam[dateTime]=2020-01-01T00%3A00%3A00.000000001Z&objParam[date]=2020-01-01&objParam[enum]=one&objParam[float32]=1.1&objParam[int32]=1&objParam[int]=1&objParam[num]=1.1&objParam[strOpt]=testOptional&objParam[str]=test", res.res.url)
    ...
    def test_deep_object_query_params_map
      ...
      res = @sdk.parameters.deep_object_query_params_map(Operations::DeepObjectQueryParamsMapRequest.new(
        map_param: {
          "test":  "value",
          "test2": "value2",
        },
    ...
    def test_json_query_params_object
      ...
      res = @sdk.parameters.json_query_params_object(Operations::JsonQueryParamsObjectRequest.new(
    ...
    def test_mixed_query_params
      ...
      res = @sdk.parameters.mixed_query_params(Operations::MixedQueryParamsRequest.new(
    ...
    def test_header_params_primitive
      ...
      res = @sdk.parameters.header_params_primitive(Operations::HeaderParamsPrimitiveRequest.new(
    ...
    def test_header_params_object
      ...
      res = @sdk.parameters.header_params_object(Operations::HeaderParamsObjectRequest.new(
          x_header_obj:        obj,
      ...
      assert_equal(Rack::Utils.status_code(:ok), res.status_code)
      refute_nil(res.res)
      assert_equal("any,any,bool,true,date,2020-01-01,dateTime,2020-01-01T00:00:00.000000001Z,enum,one,float32,1.1,int,1,int32,1,num,1.1,str,test,boolOpt,true,strOpt,testOptional", res.res.headers.x_header_obj)
      assert_equal("any=any,bool=true,date=2020-01-01,dateTime=2020-01-01T00:00:00.000000001Z,enum=one,float32=1.1,int=1,int32=1,num=1.1,str=test,boolOpt=true,strOpt=testOptional", res.res.headers.x_header_obj_explode)
    end

    def test_header_params_map
      record_test('parameters-header-params-map')

      res = @sdk.parameters.header_params_map(Operations::HeaderParamsMapRequest.new(
          x_header_map: {
            "key1": "value1",
            "key2": "value2",
          },
    ...
    def test_header_params_array
      ...
      res = @sdk.parameters.header_params_array(Operations::HeaderParamsArrayRequest.new(
