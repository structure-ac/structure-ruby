...
module OpenApiSDK
  class TestRequestBody < Minitest::Test
    ...
    def test_request_body_post_multiple_content_types_split_json_param
      ...
      res = @sdk.request_bodies.request_body_post_multiple_content_types_split_param_json(request=Operations::RequestBodyPostMultipleContentTypesSplitParamJsonRequest.new(
    ...
    def test_request_body_post_multiple_content_types_split_multipart_param
      ...
      res = @sdk.request_bodies.request_body_post_multiple_content_types_split_param_multipart(request=Operations::RequestBodyPostMultipleContentTypesSplitParamMultipartRequest.new(
    ...
    def test_request_body_post_multiple_content_types_split_form_param
      ...
      res = @sdk.request_bodies.request_body_post_multiple_content_types_split_param_form(request=Operations::RequestBodyPostMultipleContentTypesSplitParamFormRequest.new(
    ...
    def test_request_body_put_multipart_simple
      ...
      assert_equal("test", res.res.form.str)
    end
